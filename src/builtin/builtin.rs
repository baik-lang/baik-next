...
impl BuiltIn {
    pub fn new() -> Functions {
        ...
        functions.insert("panjang".to_owned(), create_len_fuction());
        functions.insert("kosong".to_owned(), create_is_empty_fuction());
        functions.insert("untaian".to_owned(), create_array_function());
        functions
    }
}
